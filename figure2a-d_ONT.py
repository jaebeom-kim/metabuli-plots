...
def figure2_AToD():
    ...
    for j in range(4):
        ...
        if j == 0:
            ...
            axs[j].text(0.5, 0.65, 'SequelCCS', fontsize=12, fontfamily='Arial',
                        horizontalalignment='center', verticalalignment='top', transform=axs[j].transAxes)
            axs[j].text(0.5, 0.57, 'Subspecies', fontsize=10, fontweight='bold', fontfamily='Arial', color='dimgrey',
                        horizontalalignment='center', verticalalignment='top', transform=axs[j].transAxes)
        elif j == 2:
            ...
            axs[j].text(0.5, 0.95, 'SequelCCS', fontsize=12, fontfamily='Arial',
                        horizontalalignment='center', verticalalignment='top', transform=axs[j].transAxes)
            axs[j].text(0.5, 0.87, 'Genus', fontsize=10, fontweight='bold', fontfamily='Arial', color='dimgrey',
                        horizontalalignment='center', verticalalignment='top', transform=axs[j].transAxes)
    ...
    covid_order = ['KrakenUniq', 'Kraken2', 'Centrifuge', 'Ensemble', 'Metabuli', 'Kraken2X', 'Kaiju', 'MMseqs2']
    ...
    marker_size = 8
    colors = ['#FFC208', '#FFC208', '#FFC208', 'dimgray', '#D81B1B', '#38BF66', '#38BF66', '#38BF66']
    correct_colors = ['orangered', 'darkgreen']
    wrong_colors = ['sandybrown', 'sandybrown', 'sandybrown', 'silver', 'salmon', 'darkseagreen', 'darkseagreen', 'darkseagreen']
    ...
    plt.savefig('./plots/figure2a-d.png', dpi=500, bbox_inches='tight')
    plt.show()
