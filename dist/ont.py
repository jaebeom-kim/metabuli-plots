...
def distribution() -> None:
    ...
    # Load Data
    gtdb_genus_tp = pd.read_csv('./prokaryote/short_1110_classifications.tsv.genus.tp', sep='\t', header=None)
    gtdb_genus_fp = pd.read_csv('./prokaryote/short_1110_classifications.tsv.genus.fp', sep='\t', header=None)
