...
def distribution() -> None:
    ...
    # Load Data
    gtdb_genus_tp = pd.read_csv('./prokaryote/genus_short_1110_classifications.tsv.genus.tp', sep='\t', header=None)
    gtdb_genus_fp = pd.read_csv('./prokaryote/genus_short_1110_classifications.tsv.genus.fp', sep='\t', header=None)
    gtdb_species_tp = pd.read_csv('./prokaryote/strain_short_1110_classifications.tsv.species.tp', sep='\t', header=None)
    ...
    virus_genus_tp = pd.read_csv('./virus/genus_short_1120_classifications.tsv.genus.tp', sep='\t', header=None)
    virus_genus_fp = pd.read_csv('./virus/genus_short_1120_classifications.tsv.genus.fp', sep='\t', header=None)
    virus_species_tp = pd.read_csv('./virus/strain_short_1120_classifications.tsv.species.tp', sep='\t', header=None)
    virus_species_fp = pd.read_csv('./virus/strain_short_1120_classifications.tsv.species.fp', sep='\t', header=None)
    ...
    y_ranges = [[850000, 850000, 99000000, 900000],
                [850000, 850000, 99000000, 900000]]
    ...
    for i in range(2):
        for j in range(4):
            ...
            axs[i, j].annotate('', xy=(0.15, 0.47), xytext=(1, 0.47), arrowprops=dict(arrowstyle='<->', color='black'))
            ...
            if j == 2 or j == 3:
                ...
                axs[i, j].annotate('', xy=(0.5, 0.35), xytext=(1, 0.35),
    ...
    # Save figure
    plt.savefig('illumina_score.png', dpi=300, bbox_inches='tight', transparent=True)
