...
def extended_figure2() -> None:
    ...
    zoom_xmins = [0.55, 0.7, 0.32]
    zoom_xmaxs = [0.85, 1, 0.37]
    zoom_ymins = [0.85, 0.92, 0.46]
    zoom_ymaxs = [1, 1, 0.51]
    zoom_locs = [4, 3, 3]
    zoom_widths = [1.5, 1.7, 0.8]
    zoom_heights = [1.5, 1.7, 0.8]
    zoom_loc1s = [1, 4, 2]
    zoom_loc2s = [2, 2, 4]
    ...
    for i in range(3):
        ...
        if i == 2:
            axin2 = inset_axes(axs[i], width=1, height=1, borderpad=0.5, bbox_transform=axs[i].transAxes,
            ...
            mark_inset(axs[i], axin2, loc1=1, loc2=3, fc="none", ec="0", lw=1)
